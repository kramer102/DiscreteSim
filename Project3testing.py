...
class Market(object):
    def __init__(self):
        ...
        if GRAB == True:
            ...
            snp_index = quandl.get("YAHOO/FUND_VFINX", authtoken="zFCX5bmbwZvgGzHu5szi", transform="rdiff", start_date="2006-01-03", end_date="2007-01-03")
            mining_eft = quandl.get("YAHOO/FUND_VGPMX", authtoken="zFCX5bmbwZvgGzHu5szi", transform="rdiff", start_date="2006-01-03", end_date="2007-01-03")
            total_bond = quandl.get("YAHOO/FUND_VBMFX", authtoken="zFCX5bmbwZvgGzHu5szi", transform="rdiff", start_date="2006-01-03", end_date="2007-01-03")
...
# %%
wallet_history1 = log.wallet_history[1]

mining_market1 = log.mining_market[1]
index_market1 = log.index_market[1]
bond_market1 = log.bond_market[1]

mining_amount1 = log.mining_amount[1]
index_amount1 = log.index_amount[1]
bond_amount1 = log.bond_amount[1]

mining_fees1 = log.mining_fees[1]
index_fees1 = log.index_fees[1]
bond_fees1 = log.bond_fees[1]

mining_bought1 = log.mining_bought[1]
mining_sold1 = log.mining_sold[1]

index_bought1 = log.index_bought[1]
index_sold1 = log.index_sold[1]

bond_bought1 = log.bond_bought[1]
bond_sold1 = log.bond_sold[1]

mining_trend1 = log.mining_trend[1]
index_trend1 = log.index_trend[1]
bond_trend1 = log.bond_trend[1]

net_worth1 = log.net_worth[1]

account_trend = log.AccountTrend
