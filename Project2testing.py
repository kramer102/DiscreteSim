...
def setup(env, trial):
    ...
    # for looking at accounts interactively
    return accounts
...
#%%
## stuff for spyder visualization
# logbook
trial = log.trial
buyhistory = log.buyhistory
sellhistory = log.sellhistory
feehistory = log.feehistory
valuehistory = log.valuehistory
wallethistory = log.wallethistory
#%%
#accounts
mining = accounts[0]
mining_values = mining.value
index = accounts[1]
index_values = index.value
bond = accounts[2]
bond_values = bond.value
